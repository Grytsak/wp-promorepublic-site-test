...
<div class="switcher-container">
    <fieldset class="switch">
        ...
        <label class="secondary-btn" for="pricing-smb">FOR SMALL BUSINESSES</label>
        <input id="pricing-agency" name="offer" type="radio">
        <label class="secondary-btn" for="pricing-agency">FOR AGENCIES AND FREELANCERS</label>
    </fieldset>
</div>
    ...
    <div class="pricing-tab pricing-tab--smb active">
        ...
        <div class="product-offer-container">
                ...
                <div class="product-offer__self-container">
                    <div class="product-offer__item">
                        <div class="product-offer__block">
                            <img src="<?php echo get_template_directory_uri(); ?>/resources/images/icons/calendar-green.svg" alt="Calendar" class="product-offer__icon">
                    ...
                    <div class="product-offer__item">
                        <div class="product-offer__block">
                            <img src="<?php echo get_template_directory_uri(); ?>/resources/images/icons/monitoring-pink.svg" alt="Monitoring" class="product-offer__icon">
                            <div class="product-offer__title">
                    ...
                    <div class="product-offer__item">
                        <div class="product-offer__block">
                            <img src="<?php echo get_template_directory_uri(); ?>/resources/images/icons/ads-blue.svg" alt="Ads" class="product-offer__icon">
                            <div class="product-offer__title">
            ...
            <div class="product-offer">
                <div class="product-offer__item">
                    <div class="product-offer__block">
                        <img src="<?php echo get_template_directory_uri(); ?>/resources/images/icons/calendar_plus-green.svg" alt="Calendar" class="product-offer__icon">
                        <div class="product-offer__title">
